--- StayAwake 测试入口（Hammerspoon 环境运行）
--- 运行：hs -c "dofile('/Users/geeyu/.hammerspoon/Spoons/StayAwake.spoon/test/run.lua')"
...
dofile(testDir .. "/timeutil_test.lua")
dofile(testDir .. "/session_test.lua")
dofile(testDir .. "/settings_test.lua")
dofile(testDir .. "/banner_test.lua")
