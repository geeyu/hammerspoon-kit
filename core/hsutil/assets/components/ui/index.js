...
function registerUiComponents(app) {
 ...
 if (typeof UiToast !== "undefined")
  app.config.globalProperties.UiToast = UiToast;
 if (typeof UiConfirm !== "undefined")
  app.config.globalProperties.UiConfirm = UiConfirm;
 if (typeof useCrud !== "undefined")
  app.config.globalProperties.useCrud = useCrud;
}
...
if (typeof window.UiButton === "undefined" && typeof UiButton !== "undefined")
 window.UiButton = UiButton;
if (typeof window.UiBadge === "undefined" && typeof UiBadge !== "undefined")
 window.UiBadge = UiBadge;
if (
 typeof window.UiStatusBadge === "undefined" &&
 typeof UiStatusBadge !== "undefined"
)
 window.UiStatusBadge = UiStatusBadge;
if (typeof window.UiDivider === "undefined" && typeof UiDivider !== "undefined")
 window.UiDivider = UiDivider;
if (typeof window.UiAvatar === "undefined" && typeof UiAvatar !== "undefined")
 window.UiAvatar = UiAvatar;
if (typeof window.UiEmpty === "undefined" && typeof UiEmpty !== "undefined")
 window.UiEmpty = UiEmpty;
if (typeof window.UiLoading === "undefined" && typeof UiLoading !== "undefined")
 window.UiLoading = UiLoading;
if (typeof window.UiInput === "undefined" && typeof UiInput !== "undefined")
 window.UiInput = UiInput;
if (typeof window.UiHotkey === "undefined" && typeof UiHotkey !== "undefined")
 window.UiHotkey = UiHotkey;
if (
 typeof window.UiDatetime === "undefined" &&
 typeof UiDatetime !== "undefined"
)
 window.UiDatetime = UiDatetime;
if (typeof window.UiSelect === "undefined" && typeof UiSelect !== "undefined")
 window.UiSelect = UiSelect;
if (typeof window.UiSwitch === "undefined" && typeof UiSwitch !== "undefined")
 window.UiSwitch = UiSwitch;
if (typeof window.UiRadio === "undefined" && typeof UiRadio !== "undefined")
 window.UiRadio = UiRadio;
if (
 typeof window.UiFormField === "undefined" &&
 typeof UiFormField !== "undefined"
)
 window.UiFormField = UiFormField;
if (typeof window.UiForm === "undefined" && typeof UiForm !== "undefined")
 window.UiForm = UiForm;
if (typeof window.UiModal === "undefined" && typeof UiModal !== "undefined")
 window.UiModal = UiModal;
if (typeof window.UiDrawer === "undefined" && typeof UiDrawer !== "undefined")
 window.UiDrawer = UiDrawer;
if (typeof window.UiConfirm === "undefined" && typeof UiConfirm !== "undefined")
 window.UiConfirm = UiConfirm;
if (typeof window.UiToast === "undefined" && typeof UiToast !== "undefined")
 window.UiToast = UiToast;
if (typeof window.UiTabs === "undefined" && typeof UiTabs !== "undefined")
 window.UiTabs = UiTabs;
if (typeof window.UiTable === "undefined" && typeof UiTable !== "undefined")
 window.UiTable = UiTable;
if (
 typeof window.UiPagination === "undefined" &&
 typeof UiPagination !== "undefined"
)
 window.UiPagination = UiPagination;
if (typeof window.UiIcon === "undefined" && typeof UiIcon !== "undefined")
 window.UiIcon = UiIcon;
if (typeof window.useCrud === "undefined" && typeof useCrud !== "undefined")
